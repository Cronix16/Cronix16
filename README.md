...
2. Static Malware Scanner (https://github.com/Cronix16/cpp-mini-antivirus):
* A defensive signature based Antivirus that utilizes dynamic memory allocation to scan files for malicious byte sequences.
